...
class _HomePageState extends State<HomePage> {
  ...
  addDocumentFirebase(){
    bandCollection.add({
      ...
      'image':'https://studiosol-a.akamaihd.net/uploadfile/letras/fotos/3/6/7/f/367f472896e70c11cadc0efe791870c7.jpg',
      'status':true,
  ...
  addDocumentIdFirebase(){
    bandCollection.doc("MandarinaQW323").set({
      'id':5,
      'band':'Disturbed',
      'image':'https://www.todorock.com/wp-content/uploads/2019/09/disturbed-1200x900.jpeg',
      'status':true,
    }).then((value) {
      print("Banda agregada");
    }).catchError((error){
  ...
  updateDocumentFirebase(){
    bandCollection.doc("kqh8x0XMqjEbhCHsoi5g").update({
      ...
      'image':'https://upload.wikimedia.org/wikipedia/commons/1/19/Belle_and_Sebastian_British_Band.jpeg',
      'status':true,
    }).then((value) {
